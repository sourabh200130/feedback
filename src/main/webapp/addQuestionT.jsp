...
<head>
	...
	<title>Add Theory Questions</title>
...
<h1 class="display-1 text-info text-center text-uppercase mb-2">Enter Theory Subject Questions</h1>
<div class="row justify-content-center h5">
    <div class="form-checked mt-3">
        <form action="tServlet" method="post">
            ...
            <div class="form-group mt-4 mb-4">
                <label for="subCode">Question no.9</label>
                <input type="text" class="form-control form-control-lg mt-2" name="nine" id="nine" aria-describedby="ariaNine" value="Enter Q.no.9">
            </div>
            <div class="form-group mt-4 mb-4">
                <label for="subCode">Question no.10</label>
                <input type="text" class="form-control form-control-lg mt-2" name="ten" id="ten" aria-describedby="ariaTen" value="Enter Q.no.10">
            </div>
